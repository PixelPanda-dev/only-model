...
//             <motion.div
//                 className="absolute left-[20%] top-[40%] -translate-x-1/2 -translate-y-1/2 will-change-transform scale-90"
//                 style={{
//                     x: mainCardX,
//                     y: mainCardY,
//                     rotateX: rotateXSpring,
...
//                 initial={{ opacity: 0, x: 190, y: -50 }}
//                 animate={{ opacity: 1, x: 0, y: 0 }}
//                 transition={{ delay: 0.4, duration: 0.8, type: "spring", bounce: 0.5 }}
//                 className="absolute right-[20%] top-[10%] will-change-transform scale-90"
//             >
//                 <div
...
//                 className="absolute left-[0%] top-[70%] -translate-y-1/2 md:left-8 will-change-transform scale-90"
//             >
//                 <div
//                     className="flex items-center gap-3 rounded-2xl border border-white/20 bg-gradient-to-br from-background/90 to-surface/80 px-4 py-3 shadow-xl backdrop-blur-md md:px-5 md:py-4"
//                     style={{ transform: "rotateY(-5deg) rotateX(3deg)" }}
...
//                 className="absolute bottom-[0%] left-[20%] md:bottom-16 md:left-8 will-change-transform scale-90"
//             >
//                 <div
//                     className="flex items-center gap-3 rounded-2xl border border-white/20 bg-gradient-to-br from-background/90 to-surface/80 px-4 py-3 shadow-xl backdrop-blur-md md:px-5 md:py-4"
//                     style={{ transform: "rotateY(-8deg) rotateX(-5deg)" }}
...
//                 className="absolute left-[0%] top-[10%] md:left-8 md:top-[34%] will-change-transform scale-90"
//             >
//                 <div
//                     className="flex items-center gap-3 rounded-2xl border border-white/20 bg-gradient-to-br from-background/90 to-surface/80 px-4 py-3 shadow-xl backdrop-blur-md md:px-5 md:py-4"
...
//                 className="absolute right-[0%] top-[40%] -translate-y-1/2 md:right-8 will-change-transform scale-90"
//             >
//                 <div
...
//                 className="absolute left-[20%] top-[0%] md:left-8 md:top-16 will-change-transform scale-90"
//             >
//                 <div
...
//                 className="absolute bottom-[0%] right-[20%] md:bottom-16 md:right-8 will-change-transform scale-90"
//             >
//                 <div
