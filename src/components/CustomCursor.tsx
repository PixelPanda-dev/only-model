...
const CustomCursor = () => {
  ...
  useEffect(() => {
    ...
    // Add event listeners for elements that should change cursor style
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed z-[9999] pointer-events-none rounded-full border-2 border-[#ff1493] transition-all duration-200 ease-out
